                            ...
                            <div className="row">
                                ...
                                <div className="col s12 m4 l4" >
                                    ...
                                    <div className="col s6 m12 l12">
                                        ...
                                        <div className=" row center " style={{margin: 0}}>
                                            <span className="col s3 m3 l3"><i className="large material-icons flight_icon" style={{ fontSize: "30px", color: "blue" }}>flight_takeoff</i></span><span className="col s6 m6 l6">{DurationCalculate(this.props.flightDetail.departs_at, this.props.flightDetail.arrives_at)}</span>  <span className="col s3 m3 l3"><i className="large material-icons flight_icon" style={{ fontSize: "30px", color: "blue" }}>flight_land</i></span>
                                ...
                                <div className="col s12 m3 l3">
                                    <div className="center-align">
                                        ...
                                        <span className="col s12 m12 l12 center-align airport">{`${destination_airport.airport}, ${destination_airport.location}, India `}</span><br />
