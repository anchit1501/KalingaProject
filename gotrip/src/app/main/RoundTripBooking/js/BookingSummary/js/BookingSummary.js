...
import $ from 'jquery';
import CouponModal from '../../../CouponModal/js/CouponModal';
...
class BookingSummaryRound extends Component {
    ...
    render() {
        ...
        let total_amount = (this.props.total * this.props.passenger);
        let total_tax = (this.props.tax * this.props.passenger);
                    ...
                    <div className="row">
                        <div className="col s12 m12 l12">
                            <div className="row borderBtm width100">
                                ...
                                <span id="bookingsumform1" className="col s12 m12 l12 left-align" style={{ fontSize: "15px", margin: 0 }}>Travelers {adult} Adult {(this.props.match.params.child != '0') ? `${this.props.match.params.child} Child ` : ''}{(this.props.match.params.infant != '0') ? `${this.props.match.params.infant} Infant` : ''}</span>
                            ...
                            <div className="col s12 m12 l12">
                                <div className="row" style={{ marginBottom: '0px' }}>
                                    ...
                                    <div id="bookingsumform1" className="col s7 m7 l9"><span className="left" style={{ fontSize: "20px" }}>Base Fare x {total_passenger}</span></div>
                                    <div id="bookingsumform1" className="col s5 m5 l3"><span className="right" style={{ fontSize: "20px" }}>₹{total_amount - total_tax}</span></div>
                                </div>
                                <div className="row">
                            ...
                            <div className=" col s12 m12 l12">
                                <div className="col s6 m6 l6"><a class="modal-trigger left" href="#coupon">View Coupons</a></div>
                                ...
                                <div className="row">
                                    ...
                                    <form id="bookingsumform1" className="col s12 m12 l12 center-align">
                            ...
                            <div className=" col s12 m12 l12" style={{ paddingTop: '20px' }}>
                                <div id="bookingsumform1" className="col s8 m8 l8" >

                                    <span className="left-align" style={{ fontSize: "20px" }}>Total Amount</span>


                                </div>
                                <div id="bookingsumform1" className="col s4 m4 l4"><span id="bookingsumform1" className="right" style={{ fontSize: "20px" }}><p style={{ margin: 0 }}>₹{total_amount + addOns}</p></span></div>
                            </div>
